...
public class Calibration_Script : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //pelvis.transform.position = pelvisPosition;
    }
    ...
    private void Update()
    {
        if (TrackerCalibrationController.count1 == true && this.count < 2)
        {
            ...
            if (modelPelvis == null)
                modelPelvis = GameObject.Find("Pelvis_Bone");
            if (modelLeftWrist == null)
                modelLeftWrist = GameObject.Find("Left_Hand");
            if (modelRightWrist == null)
                modelRightWrist = GameObject.Find("Right_Hand");
            if (modelLeftFoot == null)
                modelLeftFoot = GameObject.Find("Left_Leg");
            if (modelRightFoot == null)
                modelRightFoot = GameObject.Find("Right_Leg");
        ...
        if (this.count == 2)
        {
            ...
            Vector3 gameObject_positions = new Vector3(0f, 0f, 0f);
